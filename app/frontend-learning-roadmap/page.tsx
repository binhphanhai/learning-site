...
const juniorSkills = [
  {
    ...
    description:
      "JavaScript/TypeScript basics, React fundamentals, component styling",
    icon: <CodeOutlined />,
    skills: [
  ...
  },
  {
    ...
    icon: <DatabaseOutlined />,
    skills: ["SQL basics", "Simple query writing"],
  },
  {
    title: "Version Control & CI/CD",
    description: "Git basics and understanding CI/CD pipelines",
    icon: <RocketOutlined />,
    skills: ["Git basics", "Understanding CI/CD pipelines"],
  },
  {
...
const seniorSkills = [
  {
    ...
    description:
      "Deep JavaScript/TypeScript expertise, advanced React patterns",
    icon: <CodeOutlined />,
    skills: [
  ...
  },
  {
    ...
    icon: <BugOutlined />,
    skills: ["Unit, integration, and E2E testing", "Debugging complex issues"],
  },
  {
        ...
        <div className="max-w-7xl mx-auto p-6">
              ...
              items={[
                {
                  title: "Junior Level",
                  description:
                    "Build foundational skills in frontend development",
                  icon: <RocketOutlined />,
                },
                {
                  title: "Senior Level",
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <Paragraph className="text-lg text-gray-600">
                Advanced skills for senior frontend engineers and technical
                leaders
              </Paragraph>
            </div>
          ...
          <div className="text-center">
            <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-0">
              ...
              <Paragraph className="text-lg mb-6">
                Dive deeper into senior-level topics with our comprehensive
                learning materials
              </Paragraph>
